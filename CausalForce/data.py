...
class MultipleRisksDataset(Dataset):
        ...
        for scenario in scenarios:
            ...
            for i in range(0, len(images)-2):
                ...
                for j in range(i, i+3):
                    ...
                    objects.append(os.path.join(scenario_root, '2d_bbs_front', frame_id + '.npy'))
                ...
                self.actor_data_list.append(os.path.join(scenario_root, 'actors_data', target_frame_id + '.json'))
                self.measurement_list.append(os.path.join(scenario_root, 'measurements', target_frame_id + '.json'))
    ...
    def __getitem__(self, index):
        ...
        # Keep category labels in exactly the same order as risk_ids/risk intervals.
    ...
    def get_risk_type_by_id(risk_ids):
        """Return an object-id -> category-index map from risk_id.json."""
