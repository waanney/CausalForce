...
class Kalman_Filter(pl.LightningModule):
    def __init__(self, lr):
        super().__init__()
        self.lr = lr
        self.model = GCN_model()
        self.w_score = 1.0
        self.kalman_filter = EMATubeSmootherTorch(H=8, alpha=0.6, clamp01=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        for i in range(B):
            ...
            val_total_loss += (self.w_score*loss_scoreH8_i)
    ...
    def on_save_checkpoint(self, checkpoint: dict) -> dict:
        checkpoint['kalman_filter'] = self.kalman_filter
...
if __name__ == "__main__":
    ...
    parser.add_argument('--id', type=str, default='Kalman_Filter', help='Unique experiment identifier.')
    ...
    Kalman_Filter_Model = Kalman_Filter(args.lr)
    ...
    trainer.fit(Kalman_Filter_Model, dataloader_train, dataloader_val)
